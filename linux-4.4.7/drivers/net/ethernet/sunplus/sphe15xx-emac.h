...
#ifndef _SPHE15XX_EMAC_H_
#define _SPHE15XX_EMAC_H_

#define EMAC_INT_STATUS					0x00
#define EMAC_INT_MASK               	0x04
#define EMAC_SYS_CFGCMD               	0x08
#define EMAC_PORT_CFGSTA           		0x0C

#define EMAC_PHY_CMD                  	0x14
#define EMAC_PHY_STATUS                	0x18
#define EMAC_PAUSE_CFG                 	0x1C
#define EMAC_PAUSE_CMDSTA          		0x20
#define EMAC_MACADDR0                	0x24
#define EMAC_MACADDR1                  	0x28

#define EEPHY_SRC                   	0x78
#define ESMI_FREQ_DIV                  	0x7C
#define EMAC_TX_CFG                 	0x80
#define EMAC_TX_DESCBASEADDR         	0x84
#define EMAC_TX_DATABUFFBASEADDR      	0x88
#define EMAC_TX_CDATABUFFBASEADDR      	0x8C
#define EMAC_TX_FIFOPOINTER          	0x90
#define EMAC_TX_TRIGGER              	0x94
#define EMAC_TX_DESCSTATUS            	0x98
#define EMAC_TX_WATCHDOGTIMER       	0x9C
#define EMAC_TX_COUNTER              	0xA0

#define EMAC_RX_CFG						0x100
#define EMAC_RX_QUEUE0_DESCBASEADDR		0x104
#define EMAC_RX_QUEUE1_DESCBASEADDR		0x108
#define EMAC_RX_QUEUE2_DESCBASEADDR		0x10C
#define EMAC_RX_QUEUE3_DESCBASEADDR		0x110
#define EMAC_RX_MULTABLE0				0x114
#define EMAC_RX_MULTABLE1				0x118
#define EMAC_RX_UNICASTABLE0          	0x11C
#define EMAC_RX_UNICASTABLE1           	0x120
#define EMAC_RX_VLANTABLEGROUP0      	0x124
#define EMAC_RX_VLANTABLEGROUP1        	0x128
#define EMAC_RX_VLANTABLEGROUP2        	0x12C
#define EMAC_RX_VLANTABLEGROUP3       	0x130
#define EMAC_RX_VLAN_PRIO             	0x134
#define EMAC_RX_TOS_PRIO               	0x138
#define EMAC_RX_WATCHDOGTIMER          	0x13C
#define EMAC_RX_ERRORCNT0            	0x140
#define EMAC_RX_ERRORCNT1              	0x144
#define EMAC_RX_ERRORCNT2             	0x148

#define EEPHY_CTRL_0              		0x300
#define EEPHY_CTRL_1                 	0x304
...
#define EMAC_INT_STA_REG				(0x00)
#define EMAC_INT_CTL_REG				(0x04)
...
#define ETH_ISR_RCVDN 		(0x3fe00 ) // Receive Done
#define ETH_ISR_RXRDY 		(0x3c000 ) // Receive Buffer ready
